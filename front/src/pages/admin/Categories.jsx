              ...
              <form onSubmit={handleSubmit}>
                <div className="modal-body pt-0">
                  ...
                  <div className="mb-3">
                    ...
                    {editingCat && editingCat.image && !form.image && (
                      <div className="mb-2">
                        <img src={editingCat.image} alt="Current" style={{ width: '80px', height: '80px', borderRadius: '8px', objectFit: 'cover' }} />
                        <div className="text-muted mt-1" style={{ fontSize: '11px' }}>Current image</div>
                      </div>
                    )}
