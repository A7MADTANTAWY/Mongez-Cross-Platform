...
class WorkerRepositoryImpl implements WorkerRepository {
  ...
  Future<Either<Failure, List<WorkerModel>>> getWorkers({
    ...
    try {
      ...
      if (isAvailable != null) queryParams['available'] = isAvailable;
  ...
  @override
  Future<Either<Failure, WorkerModel>> getMyProfile() async {
    try {
      final data = await apiService.get(endPoint: Endpoints.workersMe);
      return right(WorkerModel.fromJson(data as Map<String, dynamic>));
    } catch (e) {
      if (e is DioException) {
        return left(ServerFailure.fromDioException(e));
      }
