...
import 'package:mongez/features/client/order/presentation/widgets/payment_card.dart';
import 'package:mongez/features/client/order/presentation/screens/add_card_screen.dart';
...
class _CardsScreenState extends State<CardsScreen> {
  ...
  final List<AddressModel> addresses = [
    AddressModel(address: "**** **** **** 4281", isDefault: true),
    AddressModel(address: "**** **** **** 9012"),
    AddressModel(address: "**** **** **** 6677"),
  ];
