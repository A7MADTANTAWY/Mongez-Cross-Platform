    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(lang.filter, style: textTheme.titleMedium?.copyWith(fontWeight: FontWeight.bold)),
          const SizedBox(height: 20),

          // Category
          Text(lang.category, style: textTheme.bodyMedium?.copyWith(fontWeight: FontWeight.w600)),
          ...
          // Rating filter
          Text(lang.minimumRating, style: textTheme.bodyMedium?.copyWith(fontWeight: FontWeight.w600)),
          ...
          SwitchListTile(
            ...
            title: Text(lang.availableOnly, style: textTheme.bodyMedium?.copyWith(fontWeight: FontWeight.w600)),
            value: _isAvailable,
