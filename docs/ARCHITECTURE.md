...
| 2 | **Components / deployment** | What lives inside the Docker container, how Gunicorn routes through middleware into the eight Django apps (`backend/apps/*`), where the external PostgreSQL database and `backend/media/` volume live, and how the dashboard and mobile clients connect. |
