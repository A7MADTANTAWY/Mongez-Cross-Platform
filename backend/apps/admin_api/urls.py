...
urlpatterns = [
    ...
    path("admin/workers/<int:pk>/profile/", views.AdminWorkerProfileView.as_view(), name="admin-worker-profile"),
    path("admin/workers/<int:pk>/verify/", views.AdminWorkerVerifyView.as_view(), name="admin-worker-verify"),
    path("admin/workers/<int:pk>/reject/", views.AdminWorkerRejectView.as_view(), name="admin-worker-reject"),
    ...
    path("admin/export/ratings.csv", views.AdminRatingsCSVView.as_view(), name="admin-export-ratings"),
]
